        ...
        <div class="flex items-center lg:order-2">
            ...
            <button type="button"
                ...
                @if (auth()->user()->profile_picture)
                    <img class="w-8 h-8 rounded-full" src="{{ asset('storage/profile_pictures/' . auth()->user()->profile_picture) }}"
                        alt="user photo" />
                @else
                    <img class="w-8 h-8 rounded-full" src="{{ asset('storage/profile_pictures/default.png') }}" alt="default photo" />
                @endif
